...
router.post("/signup", async (req, res) => {
  ...
  if (
    ...
    return callRes(
      ...
      "phoneNumber, password, name, birthday"
    );
  }
  if (
        ...
        jwt.sign(
          ...
          (err, token) => {
            ...
            let data = {
              ...
              coverImage: loginUser.coverImage.url
                ? loginUser.coverImage.url
                : null,
...
router.post(
  ...
  async (req, res) => {
    ...
    if (req.query.file) {
      ...
      if (
        req.query.file.mimetype != "image/jpeg" &&
        req.query.file.mimetype != "image/jpg" &&
        req.query.file.mimetype != "image/png"
      ) {
        return callRes(
          res,
          responseError.PARAMETER_VALUE_IS_INVALID,
